...
## Project Structure
    ...
    ├── base_honor_guard_ss_39008  # Django project configurations
...
1. Clone this repo and `cd base_honor_guard_ss_39008`
...
2. Clone this repo and `cd base_honor_guard_ss_39008`
